                ...
                <li className="">
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Full Stack Developer</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Data Scientist/Analyst</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>IoT Architect</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Business Intelligence Analyst</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Information Security Analyst</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Freelancer (For self-employed)</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Training Faculty</h3>
                    </div>
                  </div>
                </li>
                <li>
                  <div className='box rounded-lg bg-white'>
                    ...
                    <div className='text p-3'>
                      <h3 className='text-[#071952] my-1 font-medium text-center'>Lab Demonstrator</h3>
                    </div>
                  </div>
                </li>
              </ul>
