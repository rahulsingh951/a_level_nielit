...
import heroImg1 from "../components/assets/images/hero1.png"
          ...
          <div className='flex items-center justify-center md:flex-col'>
            <div className='left w-1/2 text-[#071952] md:w-full' data-aos="fade-right">
              <h1 className='text-5xl leading-tight text-[#071952] font-semibold'>
                '<span className="text-white">A</span>' Level</h1>
              ...
              <div className='relative text-gray-600 focus-within:text-gray-400 mt-5'>
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLScYxCFeTS_xQ2Q0oJjBF4YbQ9-XUvQQsNBo4v26W9EIy0AO5g/viewform" target="blank">
            ...
            <div className='right w-1/2 md:w-full relative'>
              <div className='images relative'>
                ...
                <div className='img h-[85vh] w-full'>
                  <img src={heroImg1} alt='' className='h-full w-full rounded-full object-contain  z-20 relative' data-aos="fade-up" />
                </div>
              </div>
              <div className='content'>
                <button className='bg-white shadow-md absolute top-44 left-0 z-30 p-2 flex items-center rounded-md' data-aos="zoom-in-down">
                  <div className='icon w-10 h-10 text-white rounded-full flex items-center justify-center bg-orange-400'>
