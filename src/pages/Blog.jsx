      ...
      <section className='courses'>
        <div className='w-4/5 m-auto'>
          ...
          <a href="https://nielit.gov.in/haridwar/content/online-courses" target="blank"> 
            ...
            <a href="https://olevel.nielitharidwar.in/" target="blank">
            <div className='box rounded-lg shadow-shadow1 bg-white' data-aos="fade-up">
              <div className='images rounded-t-lg relative overflow-hidden h-52 w-ful'>
              ...
              <div className='text p-2'>
                ...
                <div className='user flex items-center justify-between mt-6'>
                  ...
                  <div className='flex items-center text-primary'>
                  <a href="https://olevel.nielitharidwar.in/" target="blank"><span className='text-[12px] keyBg1 p-1 px-3 text-white rounded-[5px]'>Visit</span></a>
                  </div>
                </div>
              </div>
            </div>
            </a>
            <a href="https://blevel.nielitharidwar.in/" target="blank">
            <div className='box rounded-lg shadow-shadow1 bg-white' data-aos="fade-up">
              <div className='images rounded-t-lg relative overflow-hidden h-52 w-ful'>
              ...
              <div className='text p-2'>
                ...
                <div className='user flex items-center justify-between mt-6'>
                  ...
                  <div className='flex items-center text-primary'>
                  <a href="https://blevel.nielitharidwar.in/" target="blank"><span className='text-[12px] keyBg1 p-1 px-3 text-white rounded-[5px]'>Visit</span></a>
                  </div>
                </div>
              </div>
            </div>
