        ...
        <div className='container flex justify-between items-center'>
          <div className='logo flex items-center gap-4'>
            ...
            <div className='category flex items-center text-xl'>
              <span>'<span className="text-primary">A</span>' Level</span>
            </div>
          </div>
          ...
          <div className='account flex items-center gap-5'>
            <a href="https://docs.google.com/forms/d/e/1FAIpQLScYxCFeTS_xQ2Q0oJjBF4YbQ9-XUvQQsNBo4v26W9EIy0AO5g/viewform" target="blank"><button className="px-5 py-2 border text-white bg-primary hover:shadow-2xl border-white rounded-md text-sm">Apply</button></a>{" "}
